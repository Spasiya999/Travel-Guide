                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('cost_per_day') is-invalid @enderror"
                                id="cost_per_day" name="cost_per_day" value="{{ old('cost_per_day') }}" required>
                            @error('cost_per_day')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('cost_per_km') is-invalid @enderror"
                                   id="cost_per_km" name="cost_per_km" value="{{ old('cost_per_km') }}">
                            @error('cost_per_km')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="ac_available"
                                       name="ac_available" value="1" {{ old('ac_available') ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="driver_included"
                                       name="driver_included" value="1" {{ old('driver_included') ? 'checked' : '' }}>
