        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <p class="lead mb-4">Ready to explore the pearl of the Indian Ocean? I'm here to help you create unforgettable memories in Sri Lanka.</p>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="contact-card">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted">Fill out the form below and I'll get back to you within 24 hours to start planning your Sri Lanka journey.</p>
                        </div>
                        ...
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control" id="travelDates" placeholder="e.g., March 2025">
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control" id="tourType">
                                    ...
                                    <option value="Cultural Heritage">Cultural Heritage & Temples</option>
                                    <option value="Wildlife Safari">Wildlife Safari</option>
                                    <option value="Beach & Coastal">Beach & Coastal Tours</option>
                                    <option value="Tea Country">Tea Plantations & Hill Country</option>
                                    <option value="Adventure">Adventure & Hiking</option>
                                    <option value="Food Tours">Authentic Food Experiences</option>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-control" id="groupSize">
                                    ...
                                    <option value="5-8">Family/Friends (5-8 people)</option>
                                    <option value="8+">Large Group (8+ people)</option>
                                </select>
                            </div>

                            <div class="mb-4">
                                <label for="message" class="form-label fw-bold">Your Message *</label>
                                <textarea class="form-control" id="message" rows="6" placeholder="Tell me about your dream Sri Lanka experience, special interests, budget range, or any questions you have..." required></textarea>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-5">
                    ...
                    <p class="mb-0">Multiple ways to reach me - I'm here to help plan your perfect Sri Lanka adventure</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p class="mb-4">Don't wait - the best time to visit Sri Lanka is now! Contact me today and let's create memories that will last a lifetime.</p>
